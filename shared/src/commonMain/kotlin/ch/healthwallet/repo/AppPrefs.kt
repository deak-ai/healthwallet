...
data class AppPrefs(
    ...
    companion object {
        ...
        const val DEFAULT_WALTID_WALLET_API = "https://wallet2.healthwallet.li"
        const val DEFAULT_WALTID_ISSUER_API = "https://issuer2.healthwallet.li"
        const val DEFAULT_WALTID_VERIFIER_API = "https://verifier2.healthwallet.li"
        const val DEFAULT_PIS_SERVER_API = "https://pis2.healthwallet.li"
